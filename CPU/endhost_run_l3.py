...
def client():
    global origin_mac_pkt, send_iface, origin_ip_pkt, client_seq, client_ack
    ...
    # 构建标准的IP报文--将会保持不变
    origin_ip_pkt = IP(src=args.src, dst=args.dst)
    # SYN报文
...
if __name__ == '__main__':
    ...
    parser.add_argument('--iface_send', type=str, default='veth0', help='interface to send packets')
    parser.add_argument('--iface_recv', type=str, default='veth3', help='interface to receive packets')
    ...
    parser.add_argument('--dst', type=str, default='10.0.1.13',   help='destination IP')
    parser.add_argument('--sport', type=int, default=1234, help='source port')
    parser.add_argument('--dport', type=int, default=233, help='destination port')
